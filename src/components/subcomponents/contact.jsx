                            ...
                            <div className="bg-white border rounded shadow-sm overflow-hidden">
                                ...
                                <form action="#!">
                                    ...
                                    <div className="col-12">
                                        ...
                                        <input type="text" className="form-control" id="fullname" name="fullname" placeholder="Your Name" required />
                                    </div>
                                    ...
                                    <div className="col-12">
                                        ...
                                        <input type="text" className="form-control" id="subject" name="subject" placeholder="Your Subject" required />
                                    </div>
                                    <div className="col-12">
