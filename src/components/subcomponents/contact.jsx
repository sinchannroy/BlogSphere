                        ...
                        <div className="col-12 col-lg-6">
                            <div className="row justify-content-xl-center">
                                <div className="col-12 col-xl-11">
                                    ...
                                    <p className="lead fs-4 text-secondary mb-5">I am always on the lookout to get in touch with new people. If you're interested in getting in touch with me, please reach out in one of the following ways.</p>
                                    <div className="d-flex mb-5">
                                        ...
                                        <div>
                                            ...
                                            <address className="mb-0 text-secondary">https://sinchannroy.github.io/portfolio/</address>
                                        </div>
                                        </div>
                                        ...
                                        <div className="col-12 col-sm-6">
                                            ...
                                            <div>
                                                ...
                                                <p className="mb-0">
                                                <a className="link-secondary text-decoration-none" to="mailto:demo@yourdomain.com">sinchan1509@gmail.com</a>
                                                </p>
                                            </div>
                                            </div>
                                        </div>
                            ...
                            <div className="bg-white border rounded shadow-sm overflow-hidden">
                                ...
                                <form action="#!">
                                    ...
                                    <div className="col-12">
                                        ...
                                        <input type="text" className="form-control" id="fullname" name="fullname" placeholder="Your Name" value="" required />
                                    </div>
                                    ...
                                    <div className="col-12 col-md-6">
                                        ...
                                        <input type="tel" className="form-control" id="phone" name="phone" placeholder="Your Phone Number"value="" />
                                        </div>
                                    </div>
                                    <div className="col-12">
                                        <label for="subject" className="form-label">Subject <span className="text-danger">*</span></label>
                                        <input type="text" className="form-control" id="subject" name="subject" placeholder="Your Subject" value="" required />
                                    </div>
                                    <div className="col-12">
                                        <label for="message" className="form-label">Message <span className="text-danger">*</span></label>
                                        <textarea className="form-control" id="message" name="message"  placeholder="Your Message" rows="3" required></textarea>
                                    </div>
                                    <div className="col-12">
